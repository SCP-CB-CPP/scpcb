...
Function RegisterPostProcess()
    ...
    SetDefaultNamespace(GetDefaultNamespace() + "::Internal")
...
Function ToInternalTemplate.Template(hdl%)
    Return Object.Template(hdl)
End Function

Function FromInternalTemplate%(template.Template)
...
Function RegisterParticleSystem()
    ...
    RegisterTypeFromPtr("Template", %Template)
    RegisterTypeField("Template", "carray<Template@> SubTemplate", %Template\sub_template)
    RegisterTypeField("Template", "int EmitterBlend", %Template\emitter_blend)
    RegisterTypeField("Template", "int Interval", %Template\interval)
    RegisterTypeField("Template", "int ParticlesPerInterval", %Template\particles_per_interval)
    RegisterTypeField("Template", "int MaxParticles", %Template\max_particles)
    RegisterTypeField("Template", "int EmitterMaxTime", %Template\emitter_max_time)
    RegisterTypeField("Template", "int MinTime", %Template\min_time)
    RegisterTypeField("Template", "int MaxTime", %Template\max_time)
    RegisterTypeField("Template", "B3D::Texture@ Texture", %Template\tex)
    RegisterTypeField("Template", "bool AnimatedTexture", %Template\animtex)
    RegisterTypeField("Template", "float TextureFrame", %Template\texframe)
    RegisterTypeField("Template", "int MaxTextureFrames", %Template\maxtexframes)
    RegisterTypeField("Template", "float TextureSpeed", %Template\texspeed)
    RegisterTypeField("Template", "float MinOffsetX", %Template\min_ox)
    RegisterTypeField("Template", "float MaxOffsetX", %Template\max_ox)
    RegisterTypeField("Template", "float MinOffsetY", %Template\min_oy)
    RegisterTypeField("Template", "float MaxOffsetY", %Template\max_oy)
    RegisterTypeField("Template", "float MinOffsetZ", %Template\min_oz)
    RegisterTypeField("Template", "float MaxOffsetZ", %Template\max_oz)
    RegisterTypeField("Template", "float MinVelocityX", %Template\min_xv)
    RegisterTypeField("Template", "float MaxVelocityX", %Template\max_xv)
    RegisterTypeField("Template", "float MinVelocityY", %Template\min_yv)
    RegisterTypeField("Template", "float MaxVelocityY", %Template\max_yv)
    RegisterTypeField("Template", "float MinVelocityZ", %Template\min_zv)
    RegisterTypeField("Template", "float MaxVelocityZ", %Template\max_zv)
    RegisterTypeField("Template", "float MinRotationVelocity", %Template\rot_vel1)
    RegisterTypeField("Template", "float MaxRotationVelocity", %Template\rot_vel2)
    RegisterTypeField("Template", "bool AlignToFall", %Template\align_to_fall)
    RegisterTypeField("Template", "int AlignToFallOffset", %Template\align_to_fall_offset)
    RegisterTypeField("Template", "float Gravity", %Template\gravity)
    RegisterTypeField("Template", "float Alpha", %Template\alpha)
    RegisterTypeField("Template", "bool AlphaVelocity", %Template\alpha_vel)
    RegisterTypeField("Template", "float SizeX", %Template\sx)
    RegisterTypeField("Template", "float SizeY", %Template\sy)
    RegisterTypeField("Template", "float MinSizeMultiplier", %Template\size_multiplicator1)
    RegisterTypeField("Template", "float MaxSizeMultiplier", %Template\size_multiplicator2)
    RegisterTypeField("Template", "float SizeAdd", %Template\size_add)
    RegisterTypeField("Template", "float SizeMultiplier", %Template\size_mult)
    RegisterTypeField("Template", "int ColorR1", %Template\r1)
    RegisterTypeField("Template", "int ColorG1", %Template\g1)
    RegisterTypeField("Template", "int ColorB1", %Template\b1)
    RegisterTypeField("Template", "int ColorR2", %Template\r2)
    RegisterTypeField("Template", "int ColorG2", %Template\g2)
    RegisterTypeField("Template", "int ColorB2", %Template\b2)
    RegisterTypeField("Template", "int Brightness", %Template\Brightness)
    RegisterTypeField("Template", "float FloorY", %Template\floor_y)
    RegisterTypeField("Template", "float FloorBounce", %Template\floor_bounce)
    RegisterTypeField("Template", "int PitchFix", %Template\pitch_fix)
    RegisterTypeField("Template", "int YawFix", %Template\yaw_fix)
    RegisterTypeField("Template", "float Yaw", %Template\yaw)

    RegisterTypeFromPtr("Emitter", %Emitter)
    RegisterTypeField("Emitter", "bool Fixed", %Emitter\fixed)
    RegisterTypeField("Emitter", "float LoopCount", %Emitter\cnt_loop)
    RegisterTypeField("Emitter", "float Age", %Emitter\age)
    RegisterTypeField("Emitter", "float MaxTime", %Emitter\max_time)
    RegisterTypeField("Emitter", "Template@ Template", %Emitter\tmp)
    RegisterTypeField("Emitter", "B3D::Entity@ Owner", %Emitter\owner)
    RegisterTypeField("Emitter", "CB::ParticleEmitter@ Entity", %Emitter\ent)
    RegisterTypeField("Emitter", "B3D::Surface@ Surface", %Emitter\surf)
    RegisterTypeField("Emitter", "bool Deleted", %Emitter\del)
    RegisterTypeField("Emitter", "bool Frozen", %Emitter\frozen)

    RegisterTypeFromPtr("Particle", %Particle)
    RegisterTypeField("Particle", "Emitter@ Emitter", %Particle\emitter)
    RegisterTypeField("Particle", "int Age", %Particle\age)
    RegisterTypeField("Particle", "int MaxTime", %Particle\max_time)
    RegisterTypeField("Particle", "float X", %Particle\x)
    RegisterTypeField("Particle", "float Y", %Particle\y)
    RegisterTypeField("Particle", "float Z", %Particle\z)
    RegisterTypeField("Particle", "float VelocityX", %Particle\xv)
    RegisterTypeField("Particle", "float VelocityY", %Particle\yv)
    RegisterTypeField("Particle", "float VelocityZ", %Particle\zv)
    RegisterTypeField("Particle", "float Rotation", %Particle\rot)
    RegisterTypeField("Particle", "float RotationVelocity", %Particle\rot_vel)
    RegisterTypeField("Particle", "float SizeX", %Particle\sx)
    RegisterTypeField("Particle", "float SizeY", %Particle\sy)

    RegisterGlobalProperty("B3D::Camera@ Camera", &ParticleCam)
    RegisterGlobalProperty("B3D::Pivot@ Pivot", &ParticlePiv)

    RegisterObjectMethod("ParticleTemplate", "CB::Particles::Internal::Template@+ ToInternal()", @ToInternalTemplate)
    RegisterObjectMethod("Template", "CB::ParticleTemplate@ FromInternal()", @FromInternalTemplate)
