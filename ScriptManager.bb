...
Global IsAnyMenuOpen.Hooks = CreateHook("Hook_IsAnyMenuOpen", HOOK_TYPE_OVERRIDABLE)
Global IsPaused.Hooks = CreateHook("Hook_IsAnyMenuOpen", HOOK_TYPE_OVERRIDABLE)
...
Global UpdateMusic.Hooks = CreateHook("Hook_UpdateMusic", HOOK_TYPE_OVERRIDABLE)
